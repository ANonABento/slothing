...
- generic [active] [ref=e1]:
  ...
  - generic [ref=e185] [cursor=pointer]:
    - img [ref=e186]
    - generic [ref=e188]: 1 error
    - button "Hide Errors" [ref=e189]:
      - img [ref=e190]
  - generic [ref=e193]:
    - button "Keyless prompt" [expanded] [ref=e194] [cursor=pointer]:
      - img [ref=e195]
      - generic [ref=e199]: Configure your application
      - img [ref=e200]
    - generic [ref=e203]:
      - generic [ref=e204]:
        - paragraph [ref=e205]: Temporary API keys are enabled so you can get started immediately.
        - list [ref=e206]:
          - listitem [ref=e207]: Add SSO connections (eg. GitHub)
          - listitem [ref=e208]: Set up B2B authentication
          - listitem [ref=e209]: Enable MFA
        - paragraph [ref=e210]: Access the dashboard to customize auth settings and explore Clerk features.
      - link "Configure your application" [ref=e211] [cursor=pointer]:
