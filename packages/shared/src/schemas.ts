...
export function validateCreateJob(
  data: unknown,
): { success: true; data: CreateJobInput } | { success: false; errors: z.ZodError } {
...
export function validateUpdateJob(
  data: unknown,
): { success: true; data: UpdateJobInput } | { success: false; errors: z.ZodError } {
...
export function validateJobStatusUpdate(
  data: unknown,
): { success: true; data: JobStatusUpdateInput } | { success: false; errors: z.ZodError } {
