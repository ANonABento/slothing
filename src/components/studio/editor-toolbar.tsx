  ...
  return (
    <ToolbarGroup label="Text">
      ...
      <SelectControl
        ...
        onChange={(value) =>
          run(editor, (current) =>
            value ? current.setHighlight({ color: value }) : current.unsetHighlight(),
          )
        }
      >
      ...
      <ToolbarButton
        ...
        onClick={() =>
          run(editor, (current) =>
            current.unsetAllMarks().clearNodes().unsetFontFamily().unsetFontSize(),
          )
        }
      >
  ...
  return (
    <ToolbarGroup label="Paragraph">
      ...
      <SelectControl
        ...
        value=""
        disabled={disabled}
        onChange={(value) => run(editor, (current) => current.setLineHeight(value))}
      >
      ...
      <ToolbarButton
        label="Outdent"
        disabled={disabled}
        onClick={() => run(editor, (current) => current.liftListItem("listItem"))}
      >
      ...
      <ToolbarButton
        label="Indent"
        disabled={disabled}
        onClick={() => run(editor, (current) => current.sinkListItem("listItem"))}
      >
  ...
  return (
    <ToolbarGroup label="Insert">
      ...
      <ToolbarButton
        label="Page break"
        disabled={disabled}
        onClick={() => run(editor, (current) => current.insertContent({ type: "pageBreak" }))}
      >
