...
2. **libSQL database** — Local development uses `file:./.local.db`; hosted deployments use Turso.
3. **Local storage** — Uploaded files and browser-only Studio history remain local.
