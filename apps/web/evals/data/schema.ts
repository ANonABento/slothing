...
export const SeniorityLevelSchema = z.enum(["new_grad", "junior", "mid", "senior", "principal"]);
export const ScenarioSchema = z.enum(["direct_match", "stretch_up", "adjacent_role", "lateral_industry", "reach"]);
