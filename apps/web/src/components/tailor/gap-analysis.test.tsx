...
const mockGaps: GapItem[] = [
  {
    ...
    category: "skill",
    suggestion:
      'Add "docker" to Skills and support it with a project or experience bullet',
  },
  {
...
describe("ScoreRing", () => {
  ...
  it("should accept custom size and strokeWidth", () => {
    const { container } = render(
      <ScoreRing score={50} size={80} strokeWidth={6} />,
    );
...
describe("GapAnalysis", () => {
  ...
  it("should not render suggestions when no gaps", () => {
    ...
    expect(
      screen.queryByText("Improvement Suggestions"),
