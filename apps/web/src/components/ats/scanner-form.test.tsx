...
describe("ScannerForm", () => {
  ...
  it("shows a drag-drop upload area by default", () => {
    ...
    expect(screen.getByLabelText(/Upload resume PDF or text file/i)).toBeInTheDocument();
  });
  ...
  it("renders a job URL input above the manual job textarea", () => {
    ...
    expect(url.compareDocumentPosition(job) & Node.DOCUMENT_POSITION_FOLLOWING).toBeTruthy();
  });
