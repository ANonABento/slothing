...
function CommandRow({
  ...
  return (
    <Command.Item
      ...
      className={cn(
        "flex cursor-default select-none items-center gap-3 rounded-sm px-3 py-2.5 text-sm outline-none",
    ...
    >
      ...
      {item.shortcut ? (
        <kbd className="ml-auto rounded-sm bg-muted px-1.5 py-0.5 font-mono text-[10px] text-muted-foreground">
          {item.shortcut}
        </kbd>
      ) : null}
    </Command.Item>
...
export function CommandPalette() {
  ...
  return (
    <Command.Dialog
      ...
      loop
      contentClassName="fixed left-1/2 top-[12vh] z-50 grid w-[calc(100vw-2rem)] max-w-2xl -translate-x-1/2 gap-0 overflow-hidden rounded-md border border-border bg-popover text-popover-foreground shadow-[var(--shadow-elevated)]"
    ...
    >
      ...
      <div className="flex items-center border-b border-border px-4">
        ...
        />
        <kbd className="hidden rounded-sm bg-muted px-1.5 py-0.5 font-mono text-[10px] text-muted-foreground sm:inline-flex">
          ESC
        </kbd>
      </div>
      ...
      <div className="flex items-center gap-3 border-t border-border px-4 py-2 text-[10px] text-muted-foreground">
        <span className="flex items-center gap-1">
          <kbd className="rounded-sm bg-muted px-1 py-0.5 font-mono">↑↓</kbd>
          navigate
        </span>
        <span className="flex items-center gap-1">
          <kbd className="rounded-sm bg-muted px-1 py-0.5 font-mono">↵</kbd>
        ...
        <span className="flex items-center gap-1">
          <kbd className="rounded-sm bg-muted px-1 py-0.5 font-mono">esc</kbd>
          close
        </span>
      </div>
    </Command.Dialog>
