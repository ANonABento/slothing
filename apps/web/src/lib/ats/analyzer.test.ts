...
const createMinimalJob = (): JobDescription => ({
  ...
  description:
    "Looking for a skilled software engineer with React and Node.js experience.",
...
describe("analyzeATS", () => {
  ...
  it("penalizes missing email", () => {
    ...
    const hasEmailIssue = result.issues.some((i) =>
  ...
  it("penalizes missing experiences", () => {
    ...
    const hasExperienceIssue = result.issues.some((i) =>
      i.title.toLowerCase().includes("experience"),
    );
  ...
  it("penalizes missing skills", () => {
    ...
    const hasSkillsIssue = result.issues.some((i) =>
  ...
  it("detects special characters", () => {
    ...
    const hasSpecialCharIssue = result.issues.some((i) =>
      i.title.toLowerCase().includes("special character"),
    );
