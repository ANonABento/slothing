...
describe("Interview Database Functions", () => {
  ...
  describe("createInterviewSession", () => {
    it("should create a new interview session", () => {
      ...
      const result = createInterviewSession("job-123", questions, "text", TEST_USER_ID);
    ...
    it("should default to text mode", () => {
      ...
      const result = createInterviewSession("job-123", [], undefined, TEST_USER_ID);
    ...
    it("should support voice mode", () => {
      ...
      const result = createInterviewSession("job-123", [], "voice", TEST_USER_ID);
  ...
  describe("addInterviewAnswer", () => {
    it("should add an answer to a session", () => {
      ...
      const result = addInterviewAnswer("session-1", 0, "My answer", "Good!", TEST_USER_ID);
    ...
    it("should handle answers without feedback", () => {
      ...
      const result = addInterviewAnswer("session-1", 0, "My answer", undefined, TEST_USER_ID);
