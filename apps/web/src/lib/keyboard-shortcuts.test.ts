...
describe("matchesShortcut", () => {
  ...
  it("does not match simple key when ctrl is pressed", () => {
    ...
    expect(
      matchesShortcut(makeEvent({ key: "h", ctrlKey: true }), shortcut),
    ).toBe(false);
  });
  ...
  it("does not match simple key when shift is pressed", () => {
    ...
    expect(
      matchesShortcut(makeEvent({ key: "h", shiftKey: true }), shortcut),
    ).toBe(false);
  });
  ...
  it("matches ctrl shortcut with ctrlKey", () => {
    ...
    expect(
      matchesShortcut(makeEvent({ key: "u", ctrlKey: true }), shortcut),
    ).toBe(true);
  });
  ...
  it("matches ctrl shortcut with metaKey (Mac Cmd)", () => {
    ...
    expect(
      matchesShortcut(makeEvent({ key: "u", metaKey: true }), shortcut),
    ).toBe(true);
  });
