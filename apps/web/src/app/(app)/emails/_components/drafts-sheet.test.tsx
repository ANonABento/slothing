...
function makeDraft(overrides: Partial<EmailDraftForSheet> = {}): EmailDraftForSheet {
  return {
    id: "draft-1",
    type: "cold_outreach",
    jobId: "job-1",
...
describe("DraftsSheet", () => {
  ...
  it("renders an empty state", () => {
    ...
    expect(
      screen.getByText("No drafts yet. Generated emails are saved here automatically."),
    ).toBeInTheDocument();
  });
});
