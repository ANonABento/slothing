...
export function HowItWorks() {
  return (
    <MarketingSection id="how-it-works" background="muted">
      <MarketingSectionHeader
        eyebrow={
          <span className="inline-flex items-center gap-2 rounded-full border border-primary/15 bg-primary/5 px-3 py-1 text-sm font-medium text-foreground">
            How It Works
          </span>
        }
        title={
        ...
        description="No more rewriting from scratch. Upload once, tailor endlessly."
      />
